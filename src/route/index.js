...
var header = {
  ...
  salary: '600$ в месяц',
  address: '25, Gavela street, Praha, Chech',
}
...
router.get('/education', function (req, res) {
  ...
  res.render('education', {
    ...
    main: {
      educations: [
        { name: 'College High', isEnd: false },
        { name: 'College Middle', isEnd: true },
        { name: 'College Junior', isEnd: true },
      ],
      certificates: [
        { name: 'ISO 6', id: 3 },
        { name: 'ISO 100', id: 5 },
...
router.get('/work', function (req, res) {
  ...
  res.render('work', {
    ...
    main: {
      works: [
        {
          position: 'IT Administrator/Developer',
          company: {
            name: 'National Circus of Ukraine',
            url: 'https://www.circus.kiev.ua/',
          },
          duration: {
            from: '01.09.2000',
            to: null,
          ...
          projects: [
            {
              ...
              about:
                'Airbnb competitor.Hih-load appliation for searching appartmants',
              stacks: [
                {
                  name: 'React.js',
                },
              ...
              awards: [
                {
                  name: 'My first awards',
                },
                {
                  name: 'My second awards',
                },
              ],
              awardAmount: 2,
            },
